...
1. In 1-2 sentences, explain what React's `useRouteMatch` hook is used for.
    useRouteMactch is used to allow access to the data of a matching route. this allows us to render specific ui based on the URL
1. How would you explain form validation to someone who has never programmed before?
    I would say that we are essentially using logic to tell the computer what we are looking for in each field for example when logging into a normal website they have requirements like your password must include an uppercase letter.
1. In 1-2 sentences, define end to end testing.
    End to end testing is when you write code to test your program for every step that it may take giving you the ability to thoroughly check for bugs in an instant.
